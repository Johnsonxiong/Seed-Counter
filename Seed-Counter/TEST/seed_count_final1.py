...
#    print("This is the ", num_frame, " th frame")
    ...
    try:
        ...
        gray = cv2.GaussianBlur(gray, (21, 21), 0)    #blur , decease more noise
...
######################################################################################
    ...
    _, contours0, hierarchy = cv2.findContours(opening,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_NONE)              
...
#get the centroid of the contours
 ...
 #       print("The coords of the seeds is cx:",cx,"cy:",cy)
       #get the rectangle of contours
        cv2.drawContours(frame, cnt, -1, (0,255,0), 3, 8) # draw contours of every seeds
...
######################################################################################
    ...
    if k == 27:
        break
 #   cv2.imshow('Seed Count Application_frame_original',frame_ori)
 #   cv2.imshow('Seed Count Application_gray',gray)
 #   cv2.imshow('Seed Count Application_after line',frame2)
